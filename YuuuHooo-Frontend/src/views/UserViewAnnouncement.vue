...
<template>
  <div>
    ...
    <div class="overflow-auto m-10">
      ...
      <span class="text-lg font-['Acme'] font-bold">Choose Category &nbsp:
      <select class="ann-category-filter ml-3 mt-3 border border-gray rounded-md h-[2.0em] w-[7.5em] font-thin text-sm"
